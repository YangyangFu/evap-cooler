    ...
    block HeatTransfer
      ...
      Modelica.Blocks.Interfaces.RealOutput Q_latent "Latent heat transfer"
        annotation (Placement(transformation(extent={{114,-56},{134,-36}}),
            iconTransformation(extent={{114,-56},{134,-36}})));

            parameter Real Area_s= 1 "Area of the cooling pad";
            parameter Real hvs= 2675.43*1000
                                 "specific enthalphy of vapour at surface temperature";
      Modelica.Blocks.Interfaces.RealOutput Q_sensible
                                                     "sensible heat transfer"
        annotation (Placement(transformation(extent={{114,-56},{134,-36}}),
            iconTransformation(extent={{114,46},{134,66}})));
    algorithm
